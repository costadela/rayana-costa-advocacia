          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 border-b border-gold/10">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-offwhite/80 leading-relaxed">
                  Advocacia Criminal estratégica e discreta. Defesa técnica
              ...
              <div className="space-y-3 text-sm text-offwhite/80">
                <h4 className="text-offwhite font-medium text-base">
                  Contato
                </h4>
                ...
                <p>
                  <span className="text-gold">Localização:</span> Juiz de Fora,
                  MG
                </p>
              </div>
              ...
              <div className="space-y-3 text-sm text-offwhite/80">
                ...
                <p className="text-xs text-offwhite/60 pt-2">
                  Atendimento emergencial para prisões em flagrante mediante
            ...
            <div className="pt-6 border-t border-gold/5 mt-6 text-center sm:text-left">
              <p className="text-[10px] text-offwhite/30 leading-relaxed max-w-4xl">
                <strong>Aviso Legal:</strong> Este site é independente e não
                possui vínculo, patrocínio ou associação com a Meta Platforms,
                Inc. ou Google LLC. Os serviços prestados são privativos de
                advocacia, em estrita conformidade com a legislação vigente e o
